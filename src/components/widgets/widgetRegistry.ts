...
export const WIDGET_REGISTRY: WidgetRegistryEntry[] = [
  ...
  // ── PRO: Trade Journal ──
  {
    ...
    assetType: "crypto",
    label: "Trade Journal",
    desc: "Log trades with automatic market context capture",
    icon: BookOpen,
    iconColor: "text-warning",
    available: true,
    visual: { bg: "glass", shadow: "md", layout: "default", animation: "fadeIn", hoverLift: true },
    defaultSize: { w: 4, h: 5 },
    constraints: { minW: 3, minH: 4, maxW: 8, maxH: 10 },
    configFields: [],
  },
  // ── PRO: Win/Loss Pattern Detection ──
  {
    type: "trade_patterns",
    category: "pro",
    assetType: "crypto",
    label: "Pattern Detection",
    desc: "Win/Loss patterns correlated with market conditions",
    icon: Brain,
    iconColor: "text-primary",
    available: true,
    visual: { bg: "gradient", shadow: "glow", layout: "default", animation: "fadeIn", decorative: true, hoverLift: true },
